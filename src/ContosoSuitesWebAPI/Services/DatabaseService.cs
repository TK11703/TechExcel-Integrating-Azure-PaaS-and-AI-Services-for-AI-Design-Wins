...
public class DatabaseService : IDatabaseService
{
    ...
    /// </summary>
    [KernelFunction]
    [Description("Get all bookings for a single hotel on a specific begin date.")]
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate(
        [Description("The ID of the hotel")] int hotelId, 
        [Description("The date the stay will begin")] DateTime dt)
    {
    ...
    [KernelFunction]
    [Description("Get all the bookings that are missing hotel rooms.")]
    ...
    [KernelFunction]
    [Description("Get all the bookings that include multiple hotel rooms.")]
